...
Route::prefix('v1')->group(function () {
    ...
    Route::resource('nuevohermano','NuevohermanoController',['except'=>['edit','create'] ]);   // Todos los métodos menos Edit que mostraría un formulario de edición.
    Route::resource('contacto','ContactoController',['except'=>['edit','create'] ]);   // Todos los métodos menos Edit que mostraría un formulario de edición.
    ...
    // Si queremos dar  la funcionalidad de ver todos los nuevos hermanos tendremos que crear una ruta específica.
    // Pero de imagenes solamente necesitamos solamente los métodos index y show.
    // Lo correcto sería hacerlo así:
    Route::resource('nuevohermano','NuevohermanoController',[ 'only'=>['index','show'] ]);

    // Si queremos dar  la funcionalidad de ver todos los contactos tendremos que crear una ruta específica.
    // Pero de imagenes solamente necesitamos solamente los métodos index y show.
    // Lo correcto sería hacerlo así:
